...
<h3><a href="blog_item.php?id=<?php echo $linha['id'] ?>" title="Leia mais sobre: <?php echo $titulo = htmlentities($linha['titulo'], ENT_QUOTES, 'iso8859-1') ?>"><?php echo $titulo ?></a></h3>
